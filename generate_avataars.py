...
def multiavatar (hash, sansEnv, ver):
...
def generate_random_avatars(limit, dir_path):
    choices = [str(num) if num > 9 else f'0{str(num)}' for num in range(48)]
    strings = set()
    ...
    for idx, string in enumerate(strings, 1):
        svg_code = multiavatar(string, None, None)
        svg2png(bytestring=svg_code, write_to=f"{dir_path}/{idx}.png")


if __name__ == '__main__':
    generate_random_avatars(2000, "/home/wasi/personal_repos/game_score_keeper/gsk_frontend/src/public/avatars")
